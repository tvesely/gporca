...
CDistributionSpecTest::EresUnittest_Hashed()
{
	...
	CColRef *pcrA = pcf->PcrCreate(pmdtypeint4, GPOS_NEW(pmp) CMDIdGPDB(0), IDefaultTypeModifier, nameA);
	CColRef *pcrB = pcf->PcrCreate(pmdtypeint4, GPOS_NEW(pmp) CMDIdGPDB(0), IDefaultTypeModifier, nameB);
