...
namespace
{
	class GetBuilder
	{
		...
		public:
			...
			{
				CColumnDescriptor *pcoldesc = GPOS_NEW(m_pmp) CColumnDescriptor(m_pmp, m_pmdtypeint4, GPOS_NEW(m_pmp) CMDIdGPDB(0), IDefaultTypeModifier, CName(&strColumnName), iAttno, fNullable);
